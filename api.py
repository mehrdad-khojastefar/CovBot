...
class Api():
    ...
    code_names = [
        ...
        {"name": "England", "let2": "GB", "let3": "GBR"},
        {"name": "Britain", "let2": "GB", "let3": "GBR"},
        {"name": "United States", "let2": "US", "let3": "USA"},
    ...
    URL = f"{URL}{date_yesterday_str}/{date_now_str}"
    ...
    def name_to_code(self, name):
        for country in self.code_names:
            if name == country['name']:
                return country['let3']

    def get_data(self, name, record):
        return self.parsed_data['data'][self.date_yesterday_str][self.name_to_code(name)][record]
